...
def geo_dataset_train_test_text(user_feature_sequence, useful_vec, max_record, place_dim = GRID_COUNT*GRID_COUNT,
    ...
    train_X=[all_train_X_pl,all_train_X_time,all_train_X_user,all_train_X_text]
    test_X=[all_test_X_pl, all_test_X_time,all_test_X_user,all_test_X_text]

    # cPickle.dump((train_X,all_train_Y, all_train_evl,\
    #        test_X, all_test_Y, all_test_evl, \
    #        user_dim, word_vec, word_index),open('./features/trainXY1', 'w'))


    return [all_train_X_pl,all_train_X_time,all_train_X_user,all_train_X_text],all_train_Y, all_train_evl,\
           [all_test_X_pl, all_test_X_time,all_test_X_user,all_test_X_text], all_test_Y, all_test_evl, \
...
def geo_rnn_train_batch_text(train_X, train_Y, vali_X, vali_Y,vali_evl, model,center_location_list,
    ...
    for i in range(epoch):
        ...
        #print  './weights/' + dataset + '_' + MODEL_NAME + '_' + str(i) + '.h5'
        #model.save('./weights/' + dataset + '_' + MODEL_NAME + '_' + str(i) + '.h5')
